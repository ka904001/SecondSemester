...
int cl_application::exec_app() {
  ...
  string text;
  int signal;
  ob_1_p->set_connect(SIGNAL_D(ob_1_p->signal_1), ob_5_p,
                      HENDLER_D(ob_5_p->hendler_1));
  ob_1_p->set_connect(SIGNAL_D(ob_1_p->signal_2), ob_5_p,
                      HENDLER_D(ob_5_p->hendler_2));
  ob_1_p->set_connect(SIGNAL_D(ob_1_p->signal_2), ob_3_p,
                      HENDLER_D(ob_3_p->hendler_1));
